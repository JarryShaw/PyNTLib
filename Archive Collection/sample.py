...
#Return the coefficients and exponents of quotient and remainder after congruence simplification of 3x^14 + 4x^13 + 2x^11 + x^9 + x^6 + x^3 + 12x^2 + x ≡ 0 (mod 5).
print('Call simplify.')
...
print('Call pseudo.')
print('A pseudo-prime number with Fermat test (t=100000) is %d.' %jsntlib.pseudo(byte=16, para=10000, mode='Fermat', flag=False))
print('An Euler pseudo-prime number with Solovay-Stassen test (t=100000) is %d.' %jsntlib.pseudo(byte=16, para=10000, mode='Euler'))
print('A strong pseudo-prime number with Miller-Rabin test (k=100000) is %d.' %jsntlib.pseudo(byte=16, para=10000, mode='Strong'))
